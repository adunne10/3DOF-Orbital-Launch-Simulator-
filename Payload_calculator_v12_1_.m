...
[t2,Y2]=ode45(@(t,Y2) burn_2(t,Y2,stage,m_dot_2,g,alpha),[t_ignition_2 t_SECO_a],Y0_2,opts_ode);
...
function dY2dt= burn_2(t,Y2,stage,m_dot_2,g,alpha)
h=Y2(1);
v=Y2(2);
m=Y2(3);
x=Y2(4);
