...
alpha_0_vec=rad2deg(sols(:,5));
alpha_rate_vec=rad2deg(sols(:,6));
...
v_circ   = sqrt(mu / (h_orbit+r_earth));
...
c_speed = (abs(vt) - 1.02*v_circ)/v_circ;      % vt <= 1.02 vcirc   (optional)
