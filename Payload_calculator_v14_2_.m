...
vehicle_table=readtable("vehicles_v5_exp.csv");
...
N = 100; %height(vehicle_table);                        %number of rows to simulate?
%start_point=1;
...
burn_time_guess=200+((burn_time_max-200)/2);
...
% outFile = "Kourou_5deg_400km_EXP.csv";
