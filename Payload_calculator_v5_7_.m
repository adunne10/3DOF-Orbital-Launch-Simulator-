...
sol_0=   [0.05 ; -4 ; 3 ; 1000 ; 10]; %initial guess for alpha,beta,m_pld & t_coast

lowbound=[-5 ; -5 ; -5 ;100 ; 5 ]; %best guess for lower bounds
upbound= [5 ; 5 ; 5 ; 10000 ; 30]; %best guess for upper bounds
...
[h_SECO, v_SECO, theta_SECO] = trajectory(alpha, beta, charlie,m_pld,stage,R,g,t_coast,h_target);
...
function [h_SECO, v_SECO, theta_SECO] = trajectory(alpha, beta , charlie, m_pld,stage,R,g,t_coast,h_orbit)
