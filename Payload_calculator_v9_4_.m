...
sol_0=   [ pld_int            ; deg2rad(2) ; 20 ; 7  ; 500          ; 2]; %initial guess for m_pld , t_seperation , theta_kick , t_pitchover ,  t_pitch
lowbound=[ stage(1).pld_guess ; deg2rad(1) ; 10 ; 5  ; 60           ; deg2rad(0)]; %best guess for lower bounds
...
[t_2a,Y2a]=ode45(@(t,Y2a) burn_2(t,Y2a,stage,m_dot_2a,g,t_ignition_2a,t_burn_2a,theta_SES,theta_SECO),[t_ignition_2a t_SECO],Y0_2a);
...
[t_2a,Y2_a]=ode45(@(t,Y2_a) burn_2(t,Y2_a,stage,m_dot_2a,g,t_ignition_2a,t_burn_2a_optimal,theta_SES,theta_SECO_optimal),[t_ignition_2a t_SECO_a],Y0_2_a);
