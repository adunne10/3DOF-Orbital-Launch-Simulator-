...
lowbound=[ 5000 ; 1 ; deg2rad(2) ; 5 ; 5]; %best guess for lower bounds
upbound= [ 22000 ; 15 ; deg2rad(10) ; 20 ; 10]; %best guess for upper bounds

objective=@(sol) -sol(1)/1e3;

nonlcon=@(sol) constraints(sol,stage,R,g,h_orbit,v_orbit,m_earth,r_earth,theta_SECO_goal);
options=optimoptions('fmincon', 'Algorithm', 'sqp', 'MaxFunctionEvaluations', 1000 , 'Display','iter','StepTolerance',1e-8,'ConstraintTolerance',1e-4, 'OptimalityTolerance', 1e-4, 'MaxIterations', 2000);
...
[h_SECO, v_SECO] = trajectory(m_pld,stage,R,g,t_coast,t_pitchover, theta_kick,theta_SECO_goal,t_pitch);
...
function [h_SECO, v_SECO] = trajectory( m_pld,stage,R,g,t_coast,t_pitchover, theta_kick,theta_SECO_goal,t_pitch)
...
[t1a,Y1a]=ode45(@(t,Y1a) burn_1a(t,Y1a,stage,m_dot_1,R,g,t_pitchover,theta_kick,t_pitch),[0 t_burn_1a],Y0_1a);
...
theta_pitchover=theta_1a(end);
    ...
    function dY1adt= burn_1a(t,Y1a,stage,m_dot_1,R,g,t_pitchover,theta_kick,t_pitch)
h=Y1a(1);
v=Y1a(2);
m=Y1a(3);
x=Y1a(4);
...
[t1b,Y1b]=ode45(@(t,Y1b) burn_1b(t,Y1b,stage,m_dot_1,R,g),[t_burn_1a t_burn_1b+t_burn_1a],Y0_1b);
...
function dY1bdt= burn_1b(~,Y1b,stage,m_dot_1,R,g)
...
[t2,Y2]=ode45(@(t,Y2) burn_2(t,Y2,stage,m_dot_2,R,g,t_ignition_2,t_burn_2,theta_coeff),[t_ignition_2 t_SECO],Y0_2);
...
theta_SECO=theta_2(end);
    ...
    function dY2dt= burn_2(t,Y2,stage,m_dot_2,R,g,t_ignition_2 ,t_burn_2,theta_coeff)
h=Y2(1);
v=Y2(2);
m=Y2(3);
x=Y2(4);
...
[t1a,Y1a]=ode45(@(t,Y1a) burn_1a(t,Y1a,stage,m_dot_1,R,g,t_pitchover_optimal,theta_kick_optimal,t_pitch_optimal),[0 t_burn_1a],Y0_1a);
...
theta_pitchover=theta_1a(end);
    ...
    function dY1adt= burn_1a(t,Y1a,stage,m_dot_1,R,g,t_pitchover_optimal,theta_kick_optimal,t_pitch_optimal)
h=Y1a(1);
v=Y1a(2);
m=Y1a(3);
x=Y1a(4);
