...
options=optimoptions('fmincon', 'Algorithm','interior-point','FiniteDifferenceType','central' ,'Display','iter','StepTolerance',1e-8,'ConstraintTolerance',1e-4, 'OptimalityTolerance', 1e-4, 'MaxIterations', 2000);
...
[t_2a,Y2a]=ode45(@(t,Y2a) burn_2(t,Y2a,stage,m_dot_2a,g,t_ignition_2a,t_burn_2a,theta_SES,theta_SECO),[t_ignition_2a t_SECO],Y0_2a,opts_ode);
...
[t_2a,Y2_a]=ode45(@(t,Y2_a) burn_2(t,Y2_a,stage,m_dot_2a,g,t_ignition_2a,t_burn_2a_optimal,theta_SES,theta_SECO_optimal),[t_ignition_2a t_SECO_a],Y0_2_a,opts_ode);
